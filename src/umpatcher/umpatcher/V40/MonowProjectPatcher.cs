...
namespace UnityMonoDllSourceCodePatcher.V40 {
	sealed class MonowProjectPatcher : ProjectPatcherV40 {
		public MonowProjectPatcher(SolutionOptionsV40 solutionOptions)
			: base(solutionOptions, solutionOptions?.MonowProject) {
		}
        // this class is copy pasted from other patcher so I am not sure if we could cause bug here
